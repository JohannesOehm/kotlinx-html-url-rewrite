...
//
fun <T> TagConsumer<T>.urlRewrite(sessionData: String): TagConsumer<T> =
    UrlRewriteTagConsumer(this, sessionData, "q").delayed()
    ...
    override suspend fun writeTo(channel: ByteWriteChannel) {
        ...
        try {
            content.bufferedWriter().use {
                ...
                it.appendHTML().urlRewrite("\"year\":2021" ).html(block = builder)
            }
